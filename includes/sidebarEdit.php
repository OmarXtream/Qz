...
$testers = array(10,2171,1803,1804,1805,1806,1807,1808,1809,1820,1879,1873,1824,1889,1883,1048,1555,790);
$clanm = array(2,10,2171,1672,1555,1983,1884,1048);	
$coinsm = array(2,10,2171,1672,1886,1048);	
$coinslist = array(2,10,2171,1672,1555,1985,1984,1983,1048);	
$ytt = array(2,10,2171,1672,1883,1984,1983,1983,1555,1883,1048);	
$comment = array(2,10,2171,1672,1882,1893,1048,1555);	
$cprofile = array(2,10,2171,1672,1882,1048);	
// $admintab = array(10,2171,1555,1672,1557,1554,1556,1553,1548,1027,1048,1989,1988,1987,1986,1985,1984,1983,1882,1883,1884,1885,2163,2171,2212,2213);	
$admintab = array(10,2171,1555,1672,1557,1554,1556,1553,1548,1027,1048,1988,1987,1986,1985,1984,1983,1882,1883,1884,1885,2163,2171,2212,2213,1989);	
$Code = array(10,2171,1672,1548,2212,1048);	
// $jailsarch = array(10,2171,1555,1672,1557,1554,1556,1553,1989,1988,1987,1986,1985,1984,1983,1893,1048);
$jailsarch = array(10,2171,1555,1672,1557,1554,1556,1553,1988,1987,1986,1985,1984,1983,1893,1048);
$Punishmen = array(10,2171,1555,1672,1557,1554,1556,1553,1988,1987,1986,1985,1984,1983,1048,1989);		
$msgmembers = array(10,2171,1555,1672,1027,1048,1985,1984,1983);		
// $actmembers = array(10,2171,1555,1672,1557,1554,1556,1553,1989,1988,1987,1986,1985,1984,1983,1048);
$actmembers = array(10,2171,1555,1672,1557,1554,1556,1553,1988,1987,1986,1985,1984,1983,1048);
$canadv = array(10,2171,1672,1557,1986,1985,1984,1983,1555,1893,2213,1048);
$rooms = array(10,2171,1672,1557,1885,1555,1048);
//$exm = array(10,84,14,790,1413,1414,1415,1416,1417,1418,1419);
$owner = array(10,2171,1048);
$mananger = array(10,2171,1623,1048,1555);
//$ticket = array(10,2171,1555,1672,1557,1887,1048,2163);
$icon = array(10,2171,1672,1557,1554,1048,1555);
$ticket = array(1989,1988,1987,1986,1985,1984,1983,1555,1672,1048,2171,10);
...
p.ex1 {
  margin-left: 30px;
				...
				<?php if(count(array_intersect($ggids, $admintab)) || count(array_intersect($ggids, $testers)))  { ?>
						<p class="ex1">الصفحات الادارية </p>							    
...
<?php } ?>										
			...
			//			<a class="waves-effect waves-dark" href="editprofile.php" aria-expanded="false"><i class="fa fa-circle-o text-info"></i><span class="hide-menu">تعديل ملفك</span><span class="badge badge-pill badge-info">جديد</span></a>
				...
				//	</li>';                                 
					...
					<li>
						<a class="waves-effect waves-dark" href="activecode.php" aria-expanded="false"><i class="fa fa-circle-o text-cyan"></i><span class="hide-menu">تفعيل الاكواد</span><span class="badge badge-pill badge-success">مهم</span></a>
					</li>
<?php if(count(array_intersect($ggids, $vip)))  { ?>										
					
					<li> 
						<a class="waves-effect waves-dark" href="vip.php" aria-expanded="false"><i class="fa fa-circle-o text-warning"></i><span class="hide-menu">المنطقة الملكية</span><span class="badge badge-pill badge-success">مميز</span></a>
					</li> 
	<?php } ?>		
				<?php if(count(array_intersect($ggids, $prestige)))  { ?>										

					<li> 
						<a class="waves-effect waves-dark" href="Prestige.php" aria-expanded="false"><i class="fa fa-circle-o text-primary"></i><span class="hide-menu"> البرستيجات</span><span class="badge badge-pill badge-success">مميز</span></a>
					</li>
	<?php } ?>		
