...
if(isset($_POST["submit"]) && isset($_POST["group"]) && (isset($_POST["mins"]) || isset($_POST["hours"]) || isset($_POST["days"]))){
	 ...
	 $grp = intval($_POST["group"]);
		...
		$deny = array(2,9); // كل الرتب المراد حجبها
...
die('<script>
           swal({title: "ركز !!",text: "كيف تبي تنشئ كود وانت ما حطيت معلومات ؟؟",type: "error",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');
...
die('<script>
	...
	$sql = "INSERT INTO act (id, owner, user, code, time, etime, status, sgid, hidden) VALUES (NULL, '$cldbid', '0', '$code', '$now', '$tdate', '$st', '$grp', 3)";
	$con->query($sql);
...
$removez = array(2,10,1555,1557); // يقدر يحذف
...
if(isset($_POST["submit1"]) && isset($_POST["group"]) && isset($_POST["rclient"]) && (isset($_POST["mins"]) || isset($_POST["hours"]) || isset($_POST["days"]))){
	...
	// if(!in_array($grp, $xz)){	
// die('<script>
           // swal({title: "مص زوبي",text: "_!_",type: "error",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');
		   // }
	...
	if(empty($mins) && empty($hours) && empty($days)){
die('<script>
           swal({title: "ركز !!",text: "كيف تعطي الرتبه بدون مده ؟؟",type: "error",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');
	}else if(!isset($mins) && !isset($hours) && !isset($days)){
die('<script>
           swal({title: "ركز !!",text: "كيف تعطي الرتبه بدون معلومات ؟؟",type: "error",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');
	}
...
die('<script>
           swal({title: "خطاء",text: "لحدث خطأ برجاء المحاولة مرة اخرى",type: "error",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');	
...
die('<script>
           swal({title: "اووبس",text: "لا يمكنك أعطاء هذا الشخص الرتبه",type: "info",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');				
		}
		
	$ts3_VirtualServer->serverGroupClientAdd($grp, $remotedb);
	$sql = "INSERT INTO bad (id, cldbid, stime, etime, reason, punisher, sgid, status, hidden) VALUES (NULL, '$remotedb', '$now', '$tdate', '$reason', '$dbid', '$grp', '$st', 1)";
	$con->query($sql);
echo('<script>
...
die('<script>
           swal({title: "خطأ",text: "حدث خطأ",type: "error",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/A-Owner");}else {window.location.replace("https://panel.q-z.us/A-Owner");}})</script>');	
		...
		<div class="row">
			<div class="col-md-6">
                ...
                <?php
					...
					$prevx = array(9); // الرتب الى ما تطلع فى الجدول
					foreach($sgz as $sg){
						$sgi = intval($sg["sgid"]);
...
<br><br>
			...
			<div class="col-md-12">
						...
						<?php
							...
							$sql = "SELECT * FROM act WHERE hidden='3' ORDER BY id DESC LIMIT $offset,$perPage";					
							$res = $con->query($sql);
			...
			<div class="col-md-12">
						...
						//الرتبة - المنشئ - الايدي - الاسم - السبب - المدة - مسح الرتبة‬‎
							...
							$sql = "SELECT * FROM bad WHERE hidden='1' ORDER BY id DESC LIMIT $offset,$perPage";												
							$res = $con->query($sql);
