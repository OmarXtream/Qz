...
//------------------------------------------------------------------------//
// require 'includes/sweetalert.php'; 
// $brodcast = array(10,1555,1672,1557,1554,1556,1553,1548,1027,1829,1048);
// if(!count(array_intersect($brodcast, $ggids)) > 0){ die('<script>
           // swal({title: "صيانة ",text: "صيانة",type: "info",allowOutsideClick: false,allowEscapeKey: false,showCloseButton: false,confirmButtonText: "حسنأ",}).then((result) => {if (result.value) {window.location.replace("https://panel.q-z.us/");}else {window.location.replace("https://panel.q-z.us/");}})</script>');	
								// }	
?>